...
let promises2=Promise.all([p1.catch(function(error){console.log(error);}),p2.catch(function(error){console.log(error);}),p3.catch(function(error){console.log(error);}),p4.catch(function(error){console.log(error);}),p5.catch(function(error){console.log(error);})]);

promises2.then(function(data){
    data.forEach(function(data){
        console.log(data);
    })
}).catch(function(error){
